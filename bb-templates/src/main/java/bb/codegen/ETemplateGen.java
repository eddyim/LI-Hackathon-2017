...
/*TODO: Make classes generated by sections properly indented
  TODO: Render if/else blocks with proper indents as well
 */
package bb.codegen;
    ...
    class FileGenerator {
        ...
        private void handleSectionCreation(Token t, StringBuilder additionalClasses, StringBuilder importStatement) {
            ...
            if (parsedDeclaration.containsKey("params")) {
                ...
                additionalClasses.append("    ").append(currentSection.buildSection(importStatement, extendsStatement));
        ...
        private void handleLayoutCreation(Token t, StringBuilder additionalClasses, StringBuilder importStatements, int num) {
            ...
            additionalClasses.append("    ").append(headerContent.buildSection(importStatements, extendsStatement, num));
            additionalClasses.append("    ").append(footerContent.buildSection(importStatements, extendsStatement, num));
        }
        ...
        private String getIntro(String name, String packageStatement, StringBuilder extendsKeyword, int numLayouts) {
            ...
            if (!isSection && importStatements.length() > 0) {
                intro.append(importStatements).append("\n");
            }
